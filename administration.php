...
$uniqueUsernames = getUniqueUsernames();
...
$logs = getLogs($filterUsername, $filterAction, $filterStartDate, $filterEndDate);
?>
<?php include 'header.php'; ?>
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-shield-lock"></i> Administration - Logs des actions</h2>
    ...
    <div class="collapse" id="filterCollapse">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="administration.php" method="GET" class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <label for="filter_username" class="form-label">Utilisateur</label>
                        <select class="form-select" id="filter_username" name="filter_username">
                            <option value="">Tous</option>
                            <?php foreach ($uniqueUsernames as $username): ?>
                                <option value="<?= htmlspecialchars($username); ?>" <?= ($filterUsername === $username) ? 'selected' : ''; ?>>
                    ...
                    <div class="col-12">
                        ...
                        <a href="administration.php" class="btn btn-secondary"><i class="bi bi-x-circle"></i> Réinitialiser</a>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <?php if (empty($logs)): ?>
                            <tr>
                                <td colspan="4" class="text-center py-4 text-muted">Aucun log trouvé.</td>
                            </tr>
                        <?php else: ?>

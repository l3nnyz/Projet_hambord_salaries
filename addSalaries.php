    ...
    <div class="container my-5">
      <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
          <h1 class="mb-4">Ajouter un nouveau salarié</h1>
          <form action="addSalaries.php" method="POST" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback">Veuillez entrer un salaire valide (chiffres uniquement).</div>
        </div>
        <div class="mb-3">
          <label for="service" class="form-label">Service</label>
          <input type="text" class="form-control" id="service" name="service" required>
          <div class="invalid-feedback">Veuillez entrer un service.</div>
        </div>
